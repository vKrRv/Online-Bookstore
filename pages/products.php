    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        ...
        <div class="product-info">
          <h3>The boy with tiger heart</h3>
      ...
      <!-- Product 2 -->
      <div class="product-card">
        <div class="badge">most sales</div>
      ...
      <!-- Product 4 -->
      <div class="product-card">
        <img src="../images/Atomic.png" alt="Book Cover" class="book-cover" />
        <div class="product-info">
          <h3>Atomic Habits</h3>
      ...
      <!-- Product 5 -->
      <div class="product-card">
        <img src="../images/theBook.jpg" alt="Book Cover" class="book-cover" />
        <div class="product-info">
          <h3>The book</h3>
      ...
      <!-- Product 6 -->
      <div class="product-card">
        <img src="../images/book6.jpg" alt="Book Cover" class="book-cover" />
        <div class="product-info">
          <h3>Common Wisdom</h3>
          <p class="author">Author name</p>
          <div class="rating">
